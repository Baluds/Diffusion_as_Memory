...
#SBATCH --output=sbatch_scripts/slurm_output/denoiser-train-%j.out
#SBATCH --error=sbatch_scripts/slurm_output/denoiser-train-%j.err
...
echo "Train latents: ../data/latents/mod_g_psi/train_latents.pt"
echo "Val latents: ../data/latents/mod_g_psi/val_latents.pt"
echo ""
