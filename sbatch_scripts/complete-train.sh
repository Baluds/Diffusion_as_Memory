...
python3 /work/pi_dagarwal_umass_edu/project_3/bdevarangadi/Diffusion_as_Memory/scripts/training/training_dl_augmented.py \
 --latents-dir ./data/latents/u_dim_new \
 --checkpoint-dir ./checkpoints/p0/u_dim_new \
 --output-dir ./output/p0/u_dim_new \
...
python /work/pi_dagarwal_umass_edu/project_3/bdevarangadi/Diffusion_as_Memory/scripts/training/train_on_latents.py \
    --train-latents data/latents/u_dim_new/train_latents.pt \
    --val-latents data/latents/u_dim_new/val_latents.pt \
    --checkpoint-dir checkpoints/p1/u_dim_new \
    --wandb-project diffusion-as-memory \
...
python /work/pi_dagarwal_umass_edu/project_3/bdevarangadi/Diffusion_as_Memory/scripts/training/train_phase2.py \
    --p0-checkpoint ./checkpoints/p0/u_dim_new/best_model.pt \
    --denoiser-checkpoint ./checkpoints/p1/u_dim_new/best_model.pt \
    --checkpoint-dir ./checkpoints/p2/u_dim_new_temp \
    --output-dir ./output/p2/u_dim_new_temp \
    --data-dir ./data/final \
    --wandb-project diffusion-as-memory \
